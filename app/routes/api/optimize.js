...
.post(function(req, res) {
    ...
    http.get({
        ...
        response.on('end', function() {
          ...
          for (i = 0; i < totalCourses.length - 1; i++) {
            materias_i += totalCourses[i] + ", ";
            creditos_materias_i += totalCourses[i] + " " + coursesCredits[i] + ", ";
            header_requisitos += totalCourses[i] + " ";
          }
          materias_i += totalCourses[totalCourses.length - 1];
          creditos_materias_i += totalCourses[totalCourses.length - 1] + " " + coursesCredits[totalCourses.length - 1];
          header_requisitos += totalCourses[totalCourses.length - 1] + " ";
